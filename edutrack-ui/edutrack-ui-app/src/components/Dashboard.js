...
function Dashboard() {
  ...
  <div className="text-center">
    <Card className="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center" 
      style={{ width: '100px', height: '100px', fontSize: '20px' }}>
      {trainersCount}
    </Card>
    <p className="mt-2 text-primary fw-bold">Trainers</p>
  </div>
  <div className="text-center">
    <Card className="rounded-circle bg-success text-white d-flex align-items-center justify-content-center" 
      style={{ width: '100px', height: '100px', fontSize: '20px' }}>
      {studentsCount}
    </Card>
    <p className="mt-2 text-success fw-bold">Students</p>
  </div>
  <div className="text-center">
    <Card className="rounded-circle bg-warning text-dark d-flex align-items-center justify-content-center" 
      style={{ width: '100px', height: '100px', fontSize: '20px' }}>
      {batchesCount}
    </Card>
    <p className="mt-2 text-warning fw-bold">Batches</p>
  </div>
</div>
      </div>
